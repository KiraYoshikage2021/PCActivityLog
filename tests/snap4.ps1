...
$p = Get-Process PCActivityLog | Sort-Object StartTime -Descending | Where-Object { $_.MainWindowHandle -ne 0 } | Select-Object -First 1
Write-Host "PID=$($p.Id)"
...
$bmp.Save("$env:TEMP\winui_latest.png", [System.Drawing.Imaging.ImageFormat]::Png); $bmp.Dispose()
Write-Host "SNAP OK"
